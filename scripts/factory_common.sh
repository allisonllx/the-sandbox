...
factory_print_summary() {
  ...
  echo "$relax_resp" | jq '{
    archetype: .challenge_spec.classification.archetype // .challenge_blueprint.archetype,
    confidence: .challenge_spec.classification.confidence,
    ...
    spec_title: .challenge_spec.title
  }'
}
